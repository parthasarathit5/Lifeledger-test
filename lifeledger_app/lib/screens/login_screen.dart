                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text("Welcome Back", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: Color(0xFF0F172A))),
                        const SizedBox(height: 4),
                        const Text("Sign in to access your AI financial models & advisor", style: TextStyle(color: Color(0xFF64748B), fontSize: 12)),
